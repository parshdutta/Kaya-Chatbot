# 🧠 Kaya – Mental Health Support Chatbot

> ✨ *"Your AI-powered companion for compassionate, anonymous mental wellness support."*

![Kaya Banner](/UI%20&%20Chat%20Samples/UI.jpg) 

---

## 📌 Overview

**Kaya** is a cutting-edge, AI-driven chatbot designed to provide 24/7 emotional support to users facing anxiety, stress, sadness, or emotional burnout. It integrates advanced NLP techniques with ethical safety protocols to understand user sentiment, offer therapeutic responses, and detect mental health crises—anonymously and responsibly.
...
Kaya provides general mental wellness support only and is **not a replacement for licensed therapy**.  
...
- **Developer**: Parkash Dutta 
- **Email**: parkashdutta0078@gmail.com@gmail.com  
